  ...
  return (
    <section className="relative min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-6 md:px-12 pt-36 pb-0 grid grid-cols-1 lg:grid-cols-[58%_42%] gap-12 items-center min-h-[calc(100vh-80px)]">
        <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="z-10">
          <motion.p
            variants={fadeUp}
          ...
          >
            Since 2010, DLSS has been the operational backbone for Bangladesh&apos;s most demanding enterprises — from HR outsourcing to facility management, engineering to fleet telematics.
          </motion.p>
